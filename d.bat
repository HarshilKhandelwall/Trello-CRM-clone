...
ssh root@166.0.244.228 "cd /root/Trello-CRM-clone && git pull origin main && cd frontend && npm install && npm run build && cd ../backend && source venv/bin/activate && python manage.py collectstatic --noinput && systemctl restart crm"
